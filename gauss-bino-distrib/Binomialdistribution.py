...
class Binomial(Distribution):
    ...
    def __init__(self, prob=.5, size=20):
        ...
        """ Function to initialize Binomial class
        with default values of p and n as 0.5 and 20 
        Calling init function of parent class Distribution with the values of
        mean and stdev calculated according to given p and n
